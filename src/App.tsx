...
const CenterUsersView = lazy(
	() => import('@/views/CenterUsersView/CenterUsersView')
);
...
const LiaisonsView = lazy(() => import('@/views/LiaisonsView/LiaisonsView'));
const ScheduleView = lazy(() => import('@/views/ScheduleView/ScheduleView'));
